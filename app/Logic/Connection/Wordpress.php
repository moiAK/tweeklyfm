...
namespace App\Logic\Connection;
...
class Wordpress
{
    ...
    public function post()
    {
        ...
        curl_setopt($curl_post, CURLOPT_HTTPHEADER, ['Authorization: Bearer '.$connection->oauth_token]);
        curl_setopt($curl_post, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($curl_post, CURLOPT_POST, true);
        curl_setopt($curl_post, CURLOPT_POSTFIELDS, [
            'date'              => date('c'),
